    ...
    return (
      <div ref={ref} className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center py-8">
          <h2 className="text-3xl font-light mb-4 text-card-foreground">Your Estimated Price</h2>
          <div className="text-6xl font-extralight text-card-foreground my-8">
          ...
          <p className="text-muted-foreground mb-6 text-sm">This is an estimate based on your responses. Final pricing will be confirmed after consultation.</p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button className="bg-gradient-primary hover:shadow-glow transition-all duration-300 hover:-translate-y-1 text-primary-foreground px-8 py-6 text-sm tracking-widest uppercase">
              Contact Us to Book
            </Button>
    ...
    <div ref={ref} className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      {currentStep === 1 && (
        <div className="space-y-6 animate-fade-in-up">
          ...
          <h2 className="text-2xl font-light text-card-foreground mb-6">What type of event are you planning?</h2>
          <div className="grid grid-cols-2 gap-4">
            {['corporate', 'wedding', 'private', 'other'].map((type) => (
              ...
              >
                <span className="capitalize text-card-foreground">{type === 'corporate' ? 'Corporate Event' : type === 'private' ? 'Private Party' : type.charAt(0).toUpperCase() + type.slice(1)}</span>
              </button>
            ))}
          </div>
        </div>
      ...
      {currentStep === 2 && (
        <div className="space-y-6 animate-fade-in-up">
          ...
          <h2 className="text-2xl font-light text-card-foreground mb-6">How many guests are you expecting?</h2>
          <Input
            type="number"
      ...
      {currentStep === 3 && (
        <div className="space-y-6 animate-fade-in-up">
          ...
          <h2 className="text-2xl font-light text-card-foreground mb-6">What level of service do you prefer?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              >
                <div className="font-medium text-card-foreground mb-2">{level.title}</div>
      ...
      {currentStep === 4 && (
        <div className="space-y-6 animate-fade-in-up">
          ...
          <h2 className="text-2xl font-light text-card-foreground mb-6">Any special menu requirements?</h2>
          <Textarea
            ...
            className="min-h-32 text-lg p-4 border-2 focus:border-accent"
            rows={4}
          />
        </div>
      )}
      ...
      {currentStep === 5 && (
        <div className="space-y-6 animate-fade-in-up">
          ...
          <h2 className="text-2xl font-light text-card-foreground mb-6">How can we reach you?</h2>
      ...
      <div className="flex gap-4 mt-8">
        <Button
          onClick={handleBack}
          variant="secondary"
          className={`flex-1 px-6 py-6 tracking-widest uppercase text-sm ${currentStep === 1 ? 'invisible' : ''}`}
        >
          Back
        </Button>
        <Button
          onClick={handleNext}
          className="flex-1 bg-gradient-primary hover:shadow-glow transition-all duration-300 hover:-translate-y-1 text-primary-foreground px-6 py-6 tracking-widest uppercase text-sm"
        >
