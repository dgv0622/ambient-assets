        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className={`bg-gradient-subtle border border-border rounded-sm p-8 transition-all duration-500 hover:border-accent hover:shadow-card hover:-translate-y-2 ${
